import{_ as n,c as s,o as a,a as t}from"./app.378e6094.js";const h='{"title":"Style Guide","description":"","frontmatter":{},"headers":[{"level":2,"title":"Component Names","slug":"component-names"},{"level":2,"title":"Component File Names","slug":"component-file-names"},{"level":2,"title":"Number of Components","slug":"number-of-components"},{"level":2,"title":"Property and Method Names","slug":"property-and-method-names"},{"level":2,"title":"Conditional Render Methods","slug":"conditional-render-methods"},{"level":2,"title":"Event Callbacks","slug":"event-callbacks"},{"level":2,"title":"Component Structure","slug":"component-structure"}],"relativePath":"guide/advanced-style-guide.md","lastUpdated":1644425477934}',e={},p=t(`<h1 id="style-guide" tabindex="-1">Style Guide <a class="header-anchor" href="#style-guide" aria-hidden="true">#</a></h1><p>By following this Style Guide you will be able to write better code and have a better developer experience when working with Minze.</p><h2 id="component-names" tabindex="-1">Component Names <a class="header-anchor" href="#component-names" aria-hidden="true">#</a></h2><ul><li>Should always consist of at least two words.</li><li>Should be defined in <code>PascalCase</code>.</li><li>Shouldn&#39;t start with the <code>Minze</code> prefix unless they are part of one of the core <code>minze</code> packages.</li><li>Should start with a unique prefix like your company name.</li></ul><div class="language-js"><pre><code><span class="token comment">// \u2716 Bad</span>
