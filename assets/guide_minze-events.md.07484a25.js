import{_ as n,c as s,o as a,a as t}from"./app.378e6094.js";const f='{"title":"Events","description":"","frontmatter":{},"headers":[],"relativePath":"guide/minze-events.md","lastUpdated":1644425477934}',e={},p=t(`<h1 id="events" tabindex="-1">Events <a class="header-anchor" href="#events" aria-hidden="true">#</a></h1><p>The Minze class has an abstraction layer for custom events, which can be invoked by calling its static methods. This can be useful for listening to events casted from custom components. All event listeners created by <code>Minzes</code> static methods will be attached to the <code>window</code> object.</p><p>See the <a href="/api/#cast">API Reference</a> for more information.</p><p><strong>Example</strong></p><div class="language-js"><pre><code><span class="token comment">// some component</span>
