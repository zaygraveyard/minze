import{_ as n,c as s,o as a,a as t}from"./app.378e6094.js";const m='{"title":"Storage","description":"","frontmatter":{},"headers":[{"level":2,"title":"Session Storage","slug":"session-storage"},{"level":2,"title":"Local Storage","slug":"local-storage"}],"relativePath":"guide/advanced-storage.md","lastUpdated":1644425477934}',e={},p=t(`<h1 id="storage" tabindex="-1">Storage <a class="header-anchor" href="#storage" aria-hidden="true">#</a></h1><p>You can use the JavaScript native <code>sessionStorage</code> or <code>localStorage</code> properties for accessing the Storage object.</p><h2 id="session-storage" tabindex="-1">Session Storage <a class="header-anchor" href="#session-storage" aria-hidden="true">#</a></h2><p>The stored data is cleared when the page session ends.</p><p><strong>Example</strong></p><div class="language-js"><pre><code><span class="token keyword">import</span> Minze<span class="token punctuation">,</span> <span class="token punctuation">{</span> MinzeElement <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&#39;minze&#39;</span>
